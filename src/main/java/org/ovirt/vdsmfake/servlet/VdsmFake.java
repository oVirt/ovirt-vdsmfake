...
public class VdsmFake extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        output.append("running hosts: ").append(VdsmManager.getInstance().getHostCount()).append("\n");
        output.append("running vms: ").append(VdsmManager.getInstance().getRunningVmsCount()).append("\n");
